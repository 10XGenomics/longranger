...
def main(args, outs):
    ...
    a.output_alignment(aligner=aligner, aligner_params={'ref_fasta':ref_fasta, 'algorithm': args.aligner_method}, num_threads=args.__threads, read_group_header=read_group_header)
