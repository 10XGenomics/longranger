...
from tenkit.constants import PROCESSED_BARCODE_TAG, RAW_BARCODE_TAG, RAW_BARCODE_QUAL_TAG, SAMPLE_INDEX_TAG, SAMPLE_INDEX_QUAL_TAG, ILLUMINA_QUAL_OFFSET, TRIM_TAG, TRIM_QUAL_TAG
...
def main(args, outs):
    ...
    if chunk['trim']:
        COs = ['10x_bam_to_fastq:R1(RX:QX,TR:TQ,SEQ:QUAL)', '10x_bam_to_fastq:R2(SEQ:QUAL)', '10x_bam_to_fastq:I1(BC:QT)']
    else:
        COs = ['10x_bam_to_fastq:R1(RX:QX,SEQ:QUAL)', '10x_bam_to_fastq:R2(SEQ:QUAL)', '10x_bam_to_fastq:I1(BC:QT)']
